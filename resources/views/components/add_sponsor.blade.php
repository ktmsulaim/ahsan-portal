<button type="button" id="addSponsorTrigger" class="btn btn-info"><span class="material-icons">add</span> <span
    ...
    <div class="modal-dialog modal-dialog-add-sponsor" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addSponsorForm" class="modal-form-grid" action="{{ route('admin.sponsors.store') }}" method="post">
                    @csrf
