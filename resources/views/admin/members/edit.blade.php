                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="dhiu_batch" id="dhiu_batch" class="form-control" required>
                                    @for ($i = 13; $i <= 27; $i++)
                                        <option {{ $user->dhiu_batch == "Batch ".$i ? 'selected' : '' }} value="Batch {{ $i }}">Batch {{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1">    
                                            <input type="checkbox" name="marital_status" id="marital_status" class="custom-control-input" {{ $user->marital_status == 1 ? 'checked' : '' }} value={{ $user->marital_status == 1 ? true : false }}>
        ...
        <div class="col-md-4">
            ...
            <div class="mt-2 card">
                <div class="card-body">
                   ...
                   @include('components.delete_form', ['deleteUrl' => route('admin.users.delete', $user->id), 'type' => 'member'])
                </div>
            </div>
        </div>
    </div>
